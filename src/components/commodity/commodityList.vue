<template>
    <div v-loading="loading" element-loading-text="拼命加载中">
        ...
        <el-table :data="tableData" empty-text="暂无数据" border :header-cell-style="{ background: '#f0f0f0' }"
            ...
            <el-table-column prop="is_open_user	" label="是否购买会员" width="120">
                <template slot-scope="scope">
                    <div v-if="scope.row.is_open_user == 1">
                        <span>是</span>
                    </div>
                    <div v-if="scope.row.is_open_user == 2">
                        <span>否</span>
                    </div>
                </template>
            </el-table-column>
                ...
                if (self.permissionData.includes("commodityEdit")) {
                    ...
                    API.goodDetail(self.id).then(res => {
                        ...
                        self.goodsInfo = {
                            ...
                            is_open_user: res.result.is_open_user,
